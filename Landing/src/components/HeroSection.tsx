...
import ShopifyBuyButton from './ShopifyBuyButton'; // ajustá el path si está en otra carpeta
    ...
    <section className="pt-14 pb-10 px-5 md:pt-32 md:pb-24 max-w-6xl mx-auto">
      <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
        ...
        <motion.div
          ...
          {/* REEMPLAZADO: motion.a → motion.div + ShopifyBuyButton */}
          <motion.div
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="inline-block w-full md:w-auto">
            <ShopifyBuyButton
              className="inline-block w-full md:w-auto bg-accent hover:bg-yellow-500 text-dark font-heading font-bold text-lg md:text-xl py-4 px-8 rounded-full shadow-lg transition-transform text-center pt-[16px] pb-[16px]"
